...
export type ContentFittingMode = 'default' | 'fill' | 'none';
...
export declare class FancyButton extends ButtonContainer {
     ...
     */
    protected updateView(viewType: ButtonViewType, view: GetViewSettings | undefined): void;
    /**
    ...
    protected setOriginalInnerViewState(): void;
