...
class Input extends pixi_js.Container {
  ...
  constructor(options) {
    ...
    __publicField(this, "_secure", false);
    ...
    const defaultOptions = {
      bg: pixi_js.Texture.WHITE,
      textStyle: {
        fill: 0,
        align: "center"
      },
      TextClass: pixi_js.Text,
      placeholder: "",
      value: "",
      maxLength: void 0,
      secure: false,
    ...
    if (this.options?.nineSliceSprite) {
      if (typeof bgValue === "string") {
        this._bg = new pixi_js.NineSliceSprite({
          texture: pixi_js.Texture.from(bgValue),
      ...
      } else if (bgValue instanceof pixi_js.Texture) {
        this._bg = new pixi_js.NineSliceSprite({
          texture: bgValue,
          leftWidth: this.options.nineSliceSprite[0],
          topHeight: this.options.nineSliceSprite[1],
