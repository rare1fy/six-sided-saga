...
/** 魂晶 — 紫色宝石（8x8） */
export const SOUL_CRYSTAL: readonly (readonly string[])[] = [
  ['', '', '', '#4a1a6b', '#4a1a6b', '', '', ''],
  ['', '', '#4a1a6b', '#9b59b6', '#9b59b6', '#4a1a6b', '', ''],
  ['', '#4a1a6b', '#d2b4de', '#c39bd3', '#8e44ad', '#8e44ad', '#4a1a6b', ''],
  ['', '#4a1a6b', '#bb8fce', '#7d3c98', '#7d3c98', '#7d3c98', '#4a1a6b', ''],
  ['', '#4a1a6b', '#8e44ad', '#6c3483', '#6c3483', '#6c3483', '#4a1a6b', ''],
  ['', '', '#4a1a6b', '#5b2c6f', '#7d3c98', '#4a1a6b', '', ''],
  ['', '', '', '#4a1a6b', '#4a1a6b', '', '', ''],
  ['', '', '', '#3a1055', '#3a1055', '', '', ''],
] as const;
