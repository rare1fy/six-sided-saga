...
const fontFaces = [
  new FontFace('FusionPixel', "url('/src/assets/fonts/fusion-pixel-12px-monospaced-zh_hans.woff2') format('woff2')", {
    weight: '400', style: 'normal', display: 'block',
  }),
  new FontFace('FusionPixel', "url('/src/assets/fonts/fusion-pixel-12px-monospaced-latin.woff2') format('woff2')", {
